...
The Pitch and VTMaK RTIs are IEEE 1516-2010 compliant implementations. The Portico RTI is a partial implementation, i.e. not all RTI services are supported and the data encoding is not compliant with the HLA standard.
